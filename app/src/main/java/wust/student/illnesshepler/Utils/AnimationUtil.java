 ...
 * 调用方式： view.startAnimation(AnimationUtil.method(...));
 */
public class AnimationUtil {
    ...
    public static Animation inFromTopAnimation(Context context) {
        Animation inFromTop = new TranslateAnimation(0.0f, 0.0f, -ScreenUtil.getScreenHeight(context), 0.0f);
    ...
    public static Animation outToTopAnimation(Context context) {
        Animation outToTop = new TranslateAnimation(0.0f, 0.0f, 0.0f, -ScreenUtil.getScreenHeight(context));
    ...
    public static Animation inFromBottomAnimation(Context context) {
        Animation inFromBottom = new TranslateAnimation(0.0f, 0.0f, ScreenUtil.getScreenHeight(context), 0.0f);
    ...
    public static Animation outToBottomAnimation(Context context) {
        Animation outToBottom = new TranslateAnimation(0.0f, 0.0f, 0.0f, ScreenUtil.getScreenHeight(context));
