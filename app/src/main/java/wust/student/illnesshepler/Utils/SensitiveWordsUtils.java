...
//    public static synchronized void initSensitiveWord(Set<String> sensitiveWordSet ) {
//        initSensitiveWordMap(sensitiveWordSet);
//    }

    public static void initSensitiveWord( InputStream inputStream)
    {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                sensitiveWordSet.add(SensitiveWordsUtils.unicodetoString(line));
                i++;
            }
            inputStream.close();
    ...
    private static void initSensitiveWordMap(Set<String> sensitiveWordSet) {
        ...
        Log.d("test",+sensitiveWordSet.size()+"");
        String key;
        Map nowMap;
